...
namespace ValueEngine.Input
{
    public class Mouse
    {
        ...
        public Mouse(Form form, Control openGLControl)
        {
            ...
            _openGLControl.MouseUp += delegate(object oj, MouseEventArgs e)
            {
                if (e.Button == MouseButtons.Left)
                {
                    LeftHeld = false;
            ...
            {
                //if you move the mouse out of the window then release all held buttons
                LeftHeld = false;
                RightHeld = false;
                MiddleHeld = false;
            };
        ...
        private void UpdateMousePosition()
        {
            ...
            //Using our point defition
            ValueEngine.Point adjustedMousePoint = new ValueEngine.Point();
